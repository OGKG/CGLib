...
from CGLib.preparata import preparata
...
class TestAlgorithms(TestCase):
    ...
    def test_preparata1(self):
        ...
        self.assertEqual((hull0, tree0), next(ans))
        self.assertEqual((left_paths, right_paths), next(ans))
        self.assertEqual(deleted_points, next(ans))
        self.assertEqual((hulls, trees), next(ans))
        self.assertEqual(hull, next(ans))
    
    def test_preparata2(self):
